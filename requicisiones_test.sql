...
-- Dumping data for table proverde.authorization: ~0 rows (approximately)
...
-- Dumping data for table proverde.department: ~0 rows (approximately)
...
-- Dumping data for table proverde.employee: ~0 rows (approximately)
/*!40000 ALTER TABLE `employee` DISABLE KEYS */;
INSERT INTO `employee` (`id`, `name`, `user`, `department_assigned`) VALUES
	(1010, 'Prueba Uno', 'delta.bravo', 'Control'),
	(5555, 'Gerente Planta', 'plant_man', NULL),
	(6666, 'Conta Prueba', 'cont.pru', NULL);
...
-- Dumping data for table proverde.items: ~0 rows (approximately)
...
-- Dumping data for table proverde.manager: ~0 rows (approximately)
/*!40000 ALTER TABLE `manager` DISABLE KEYS */;
INSERT INTO `manager` (`department_name`, `manager_id`) VALUES
	('Finanzas', 6666),
	('Planta', 5555);
...
-- Dumping data for table proverde.request: ~0 rows (approximately)
